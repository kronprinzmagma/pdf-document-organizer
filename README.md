...
> **About this repository:** Public, sanitised version of a private working repo that the author uses on real personal correspondence (tax, banking, insurance). The code is identical; this repo ships with a synthetic test set instead of real PDFs. Actively maintained · last release May 2026.
