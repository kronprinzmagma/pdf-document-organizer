...
def doc_ekz_stromrechnung(c):
    ...
    text(c, 2, 14.2, "IBAN: CH56 0483 5012 3456 7800 9")  # gitleaks:allow
...
def doc_swisscom_rechnung(c):
    ...
    text(c, 2, 17.2, "Zahlbar bis: 20.10.2025  |  IBAN: CH93 0076 2011 6238 5295 7")  # gitleaks:allow
...
def doc_kb_kontoauszug(c):
    ...
    text(c, 2, 24.4, "Konto:        CH38 0070 0110 0061 1600 2")  # gitleaks:allow
...
def doc_helsana_praemie(c):
    ...
    text(c, 2, 21.8, "AHV-Nummer:           756.4821.9034.17")  # gitleaks:allow
    hline(c, 21.4)
    ...
    text(c, 2, 16.0, "IBAN: CH56 0900 0000 3000 3233 3")  # gitleaks:allow
...
def doc_steuer_kanton(c):
    ...
    text(c, 2, 21.8, "AHV-Nummer:        756.9823.4712.06")  # gitleaks:allow
    ...
    text(c, 2, 15.4, "IBAN: CH56 0707 0032 0100 0000 4")  # gitleaks:allow
...
def doc_gemeinde_mahnung(c):
    ...
    text(c, 2, 17.4, "AHV-Nummer:  756.2211.4499.83")  # gitleaks:allow
...
def doc_axa_versicherung(c):
    ...
    text(c, 2, 17.2, "IBAN: CH56 0900 0000 3100 9999 9")  # gitleaks:allow
...
def doc_migros_bank_kreditkarte(c):
    ...
    text(c, 2, 15.6, "IBAN: CH56 0840 1016 4344 2000 9")  # gitleaks:allow
...
def doc_zurich_auto(c):
    ...
    text(c, 2, 16.0, "IBAN: CH56 0900 0000 3000 0000 0")  # gitleaks:allow
...
def doc_postfinance_konto(c):
    ...
    hline(c, 25.8)
    text(c, 2, 25.2, "KONTOAUSZUG", 14, bold=True)
    text(c, 2, 24.4, "IBAN: CH56 0900 0000 8706 0000 6")  # gitleaks:allow
...
def doc_gemeinde_wasser(c):
    ...
    text(c, 2, 16.6, "IBAN: CH56 0077 0016 0444 2600 1")  # gitleaks:allow
...
def doc_raiffeisen_hypothek(c):
    ...
    text(c, 2, 17.2, "Belastung IBAN: CH56 8080 8001 2345 6789 0  am 01.10.2025")  # gitleaks:allow
...
def doc_ahv_beitrag(c):
    ...
    text(c, 2, 22.4, "AHV-Nummer:       756.8831.2244.05")  # gitleaks:allow
    ...
    text(c, 2, 16.0, "1. Rate fällig: 31.03.2026  |  IBAN: CH56 0900 0000 3000 1111 2")  # gitleaks:allow
...
def doc_sbb_ga(c):
    ...
    text(c, 2, 17.2, "IBAN: CH56 0900 0000 1515 1515 1")  # gitleaks:allow
...
def doc_schulgeld(c):
    ...
    text(c, 2, 16.6, "IBAN: CH56 0707 0032 0100 2222 2")  # gitleaks:allow
...
def doc_css_leistung(c):
    ...
    text(c, 2, 21.8, "AHV-Nummer:          756.3344.5566.77")  # gitleaks:allow
...
def doc_kehricht(c):
    ...
    text(c, 2, 18.0, "IBAN: CH56 0023 3233 1131 2300 1")  # gitleaks:allow
...
def doc_pk_ausweis(c):
    ...
    text(c, 2, 23.2, "AHV-Nummer:         756.1122.3344.55")  # gitleaks:allow
...
def doc_miete(c):
    ...
    text(c, 2, 16.6, "IBAN: CH56 0483 5012 9988 7700 3")  # gitleaks:allow
...
def doc_fahrzeugsteuer(c):
    ...
    text(c, 2, 17.8, "Zahlbar bis: 31.01.2026")
    text(c, 2, 17.2, "IBAN: CH56 0070 0110 0030 4400 9")  # gitleaks:allow
